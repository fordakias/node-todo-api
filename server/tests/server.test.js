...
describe('POST /todos',() =>{
  it('should create a new todo', (done) =>{
    ...
    it ('should not create todo with the invalid body data', (done)=>{
      var text = '';
    ...
    describe('GET /todos/:id', ()=>{
      it('should get specific ID todo' , (done) => {
        request(app)
    ...
    describe('DELETE /todos/:id', (done) =>{
      ...
      it('should return 404 if object id id invalid', (done) =>{
        request(app)
        .delete('/todos/123abc')
        .expect(404)
        .end(done);
...
describe('DELETE /users/me/token', () =>{
  it('should remove auth token on lohout', (done) =>{
    request(app)
